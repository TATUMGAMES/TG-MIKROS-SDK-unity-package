...
/// Create the [AnalyticsEventConfiguration] object.
/// Will throw [IllegalArgumentException] if attribute logic is not correct.
///
/// returns:
...
///
SWIFT_CLASS("_TtC20mikros_framework_ios31AnalyticsExceptionConfiguration")
@interface AnalyticsExceptionConfiguration : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
SWIFT_CLASS("_TtC20mikros_framework_ios38AnalyticsExceptionConfigurationBuilder")
@interface AnalyticsExceptionConfigurationBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Setter for <a href="x-source-tag://eventLogging">eventLogging</a>
/// for setting properties of Mikros Analytics exception event tracking.
/// \param eventLogging Allow to disable/enable the Mikros Analytics logger.
/// True by default.
///
///
/// returns:
/// <a href="x-source-tag://AnalyticsExceptionConfigurationBuilder">AnalyticsExceptionConfigurationBuilder</a>
- (AnalyticsExceptionConfigurationBuilder * _Nonnull)setWithEventLogging:(BOOL)eventLogging SWIFT_WARN_UNUSED_RESULT;
/// Create the [AnalyticsExceptionConfiguration] object.
/// Will throw [IllegalArgumentException] if attribute logic is not correct.
///
/// returns:
/// <a href="x-source-tag://AnalyticsExceptionConfiguration">AnalyticsExceptionConfiguration</a>
- (AnalyticsExceptionConfiguration * _Nullable)createAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC20mikros_framework_ios30AnalyticsGameplayConfiguration")
@interface AnalyticsGameplayConfiguration : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC20mikros_framework_ios37AnalyticsGameplayConfigurationBuilder")
@interface AnalyticsGameplayConfigurationBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Setter for <a href="x-source-tag://eventLogging">eventLogging</a>
/// for setting properties of Mikros Analytics exception event tracking.
/// \param eventLogging Allow to disable/enable the Mikros Analytics logger.
...
///
/// returns:
/// <a href="x-source-tag://AnalyticsGameplayConfigurationBuilder">AnalyticsExceptionConfigurationBuilder</a>
- (AnalyticsGameplayConfigurationBuilder * _Nonnull)setWithEventLogging:(BOOL)eventLogging SWIFT_WARN_UNUSED_RESULT;
/// Create the [AnalyticsExceptionConfiguration] object.
/// Will throw [IllegalArgumentException] if attribute logic is not correct.
///
/// returns:
/// <a href="x-source-tag://AnalyticsGameplayConfiguration">AnalyticsGameplayConfiguration</a>
- (AnalyticsGameplayConfiguration * _Nullable)createAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end


///
SWIFT_CLASS("_TtC20mikros_framework_ios28AnalyticsMemoryConfiguration")
@interface AnalyticsMemoryConfiguration : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
SWIFT_CLASS("_TtC20mikros_framework_ios35AnalyticsMemoryConfigurationBuilder")
@interface AnalyticsMemoryConfigurationBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Setter for <a href="x-source-tag://minimumQueueSize">minimumQueueSize</a>
/// for setting properties of Mikros Analytics event tracking.
/// \param minimumQueueSize Minimum queue size before making post calls to Mikros.
...
///
/// returns:
/// <a href="x-source-tag://AnalyticsMemoryConfigurationBuilder">AnalyticsConfigurationBuilder</a>
- (AnalyticsMemoryConfigurationBuilder * _Nonnull)setWithMinimumQueueSize:(NSInteger)minimumQueueSize SWIFT_WARN_UNUSED_RESULT;
/// Setter for <a href="x-source-tag://maximumQueueSize">maximumQueueSize</a>
/// for setting properties of Mikros Analytics event tracking.
/// \param maximumQueueSize Max queue size for making post calls to Mikros.
///
...
/// returns:
/// <a href="x-source-tag://AnalyticsMemoryConfigurationBuilder">AnalyticsConfigurationBuilder</a>
- (AnalyticsMemoryConfigurationBuilder * _Nonnull)setWithMaximumQueueSize:(NSInteger)maximumQueueSize SWIFT_WARN_UNUSED_RESULT;
/// Setter for <a href="x-source-tag://recurringTaskInMinutes">recurringTaskInMinutes</a>
/// for setting properties of Mikros Analytics event tracking.
/// \param recurringTaskInMinutes Configurable time to schedule task to post Mikros events.
/// Default is 600 minutes (10 hours).
...
/// returns:
/// <a href="x-source-tag://AnalyticsMemoryConfigurationBuilder">AnalyticsConfigurationBuilder</a>
- (AnalyticsMemoryConfigurationBuilder * _Nonnull)setWithRecurringTaskInMinutes:(int64_t)recurringTaskInMinutes SWIFT_WARN_UNUSED_RESULT;
/// Setter for <a href="x-source-tag://eventLogging">eventLogging</a>
/// for setting properties of Mikros Analytics event tracking.
/// \param eventLogging Allow to disable/enable the Mikros Analytics logger.
/// True by default.
...
/// returns:
/// <a href="x-source-tag://AnalyticsMemoryConfigurationBuilder">AnalyticsConfigurationBuilder</a>
- (AnalyticsMemoryConfigurationBuilder * _Nonnull)setWithEventLogging:(BOOL)eventLogging SWIFT_WARN_UNUSED_RESULT;
/// Create the [AnalyticsMemoryConfiguration] object.
/// Will throw [IllegalArgumentException] if attribute logic is not correct.
///
/// returns:
/// <a href="x-source-tag://AnalyticsMemoryConfiguration">AnalyticsMemoryConfiguration</a>
- (AnalyticsMemoryConfiguration * _Nullable)createAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Create the [AnalyticsSessionConfiguration] object.
/// Will throw [IllegalArgumentException] if attribute logic is not correct.
///
/// returns:
...
SWIFT_PROTOCOL("_TtP20mikros_framework_ios47MikrosAnalyticsExceptionConfigurationProperties_")
@protocol MikrosAnalyticsExceptionConfigurationProperties
/// Method used to update the value of event logging, allowing to enable or disable
/// Mikros Analytics events once the configuration has been set.
/// Enable or disable Mikros Analytics Exceptiob tracking.
- (void)updateCrashEventLoggingWithIsEnabled:(BOOL)isEnabled;
/// Returns <a href="x-source-tag://AnalyticsExceptionConfiguration">AnalyticsExceptionConfiguration</a> information
/// used by the <a href="x-source-tag://MikrosApiClient">MikrosApiClient</a>.
///
/// returns:
/// <a href="x-source-tag://AnalyticsExceptionConfiguration">AnalyticsExceptionConfiguration</a>
- (AnalyticsExceptionConfiguration * _Nonnull)getAnalyticsExceptionConfiguration SWIFT_WARN_UNUSED_RESULT;
/// Update analytics configuration.
/// The updated changes only apply if <a href="x-source-tag://MikrosApiClient">MikrosApiClient</a> is initialized.
/// \param analyticssExceptionConfiguration Configuration that collects information
/// about how to handle processed Exception for Mikros Analytics.
///
- (void)updateAnalyticsExceptionConfigurationWithAnalyticssExceptionConfiguration:(AnalyticsExceptionConfiguration * _Nonnull)analyticssExceptionConfiguration;
@end


/// Interface for main entry point for Mikros Analytics Exception logging.
/// This public interface extends
/// <a href="x-source-tag://MikrosAnalyticsExceptionConfigurationProperties">MikrosAnalyticsExceptionConfigurationProperties</a>
SWIFT_PROTOCOL("_TtP20mikros_framework_ios30MikrosAnalyticsExceptionLogger_")
@protocol MikrosAnalyticsExceptionLogger <MikrosAnalyticsExceptionConfigurationProperties>
/// Method used to update the value of event logging, allowing to enable or disable
/// Mikros Analytics events once the configuration has been set.
/// Enable or disable Mikros Analytics Exception tracking.
- (void)updateCrashEventLoggingWithIsEnabled:(BOOL)isEnabled;
/// Returns <a href="x-source-tag://AnalyticsExceptionConfiguration">AnalyticsExceptionConfiguration</a> information
/// used by the <a href="x-source-tag://MikrosApiClient">MikrosApiClient</a>.
///
...
SWIFT_PROTOCOL("_TtP20mikros_framework_ios46MikrosAnalyticsGameplayConfigurationProperties_")
@protocol MikrosAnalyticsGameplayConfigurationProperties
/// Method used to update the value of game play time logging, allowing to enable or disable
/// Mikros Analytics game play times once the configuration has been set.
/// Enable or disable Mikros Analytics game play time tracking.
- (void)updateGameplayLoggingWithIsEnabled:(BOOL)isEnabled;
/// Returns <a href="x-source-tag://AnalyticsGameplayConfiguration">AnalyticsGameplayConfiguration</a> information
/// used by the <a href="x-source-tag://MikrosApiClient">MikrosApiClient</a>.
///
/// returns:
/// <a href="x-source-tag://AnalyticsGameplayConfiguration">AnalyticsGameplayConfiguration</a>
- (AnalyticsGameplayConfiguration * _Nonnull)getAnalyticsGameplayConfiguration SWIFT_WARN_UNUSED_RESULT;
/// Update analytics configuration.
/// The updated changes only apply if <a href="x-source-tag://MikrosApiClient">MikrosApiClient</a> is initialized.
/// \param analyticsGameplayConfiguration Configuration that collects information
/// about how to handle processed game play times for Mikros Analytics.
///
- (void)updateAnalyticsConfigurationWithAnalyticsGameplayConfiguration:(AnalyticsGameplayConfiguration * _Nonnull)analyticsGameplayConfiguration;
@end


/// Interface for main entry point for Mikros Analytics game play time logging.
/// This public interface extends
/// <a href="x-source-tag://MikrosAnalyticsGameplayConfigurationProperties">MikrosAnalyticsGameplayConfigurationProperties</a>
SWIFT_PROTOCOL("_TtP20mikros_framework_ios29MikrosAnalyticsGameplayLogger_")
@protocol MikrosAnalyticsGameplayLogger <MikrosAnalyticsGameplayConfigurationProperties>
/// Method used to flush game play time in current queue. This will fire a one time task to
/// flush game play time.
- (void)flushGameplayEvents;
@end


SWIFT_PROTOCOL("_TtP20mikros_framework_ios44MikrosAnalyticsMemoryConfigurationProperties_")
@protocol MikrosAnalyticsMemoryConfigurationProperties
- (void)updateMemoryLoggingWithIsEnabled:(BOOL)isEnabled;
- (void)updateMemoryMinimumQueueSizeWithMinimumQueueSize:(NSInteger)minimumQueueSize;
- (void)updateMemoryMaximumQueueSizeWithMaximumQueueSize:(NSInteger)maximumQueueSize;
- (void)updateMemoryRecurringTaskInMinutesWithRecurringTaskInMinutes:(int64_t)recurringTaskInMinutes;
- (AnalyticsMemoryConfiguration * _Nonnull)getAnalyticsMemoryConfiguration SWIFT_WARN_UNUSED_RESULT;
- (void)updateAnalyticsMemoryConfigurationWithAnalyticsMemoryConfiguration:(AnalyticsMemoryConfiguration * _Nonnull)analyticsMemoryConfiguration;
@end


SWIFT_PROTOCOL("_TtP20mikros_framework_ios27MikrosAnalyticsMemoryLogger_")
@protocol MikrosAnalyticsMemoryLogger <MikrosAnalyticsMemoryConfigurationProperties>
- (void)flushMemoryEvents;
@end
...
@protocol MikrosApiClientProtocol <NSObject, MikrosAnalyticsEventLogger, MikrosAnalyticsExceptionLogger, MikrosAnalyticsGameplayLogger, MikrosAnalyticsMemoryLogger, MikrosAnalyticsSessionLogger>
///
/// returns:
...
/// A <code>singleton</code> instance provider for [MikrosApiClientInterface]. The client should [initialize] the provider first before using [getInstance].
SWIFT_CLASS("_TtC20mikros_framework_ios23MikrosApiClientProvider")
@interface MikrosApiClientProvider : NSObject
+ (BOOL)initializeWithClientConfiguration:(ClientConfiguration * _Nonnull)clientConfiguration analyticsEventConfiguration:(AnalyticsEventConfiguration * _Nullable)analyticsEventConfiguration analyticsSessionConfiguration:(AnalyticsSessionConfiguration * _Nullable)analyticsSessionConfiguration analyticsMemoryConfiguration:(AnalyticsMemoryConfiguration * _Nullable)analyticsMemoryConfiguration analyticsExceptionConfiguration:(AnalyticsExceptionConfiguration * _Nullable)analyticsExceptionConfiguration analyticsGameplayConfiguration:(AnalyticsGameplayConfiguration * _Nullable)analyticsGameplayConfiguration error:(NSError * _Nullable * _Nullable)error;
...
@interface MikrosGameplayEntity (SWIFT_EXTENSION(mikros_framework_ios))
@property (nonatomic, copy) NSString * _Nullable gameplayStartTime;
@property (nonatomic, copy) NSString * _Nullable gameplayEndTime;
@end
...
/// Setter for deviceBattery.
/// \param deviceBattery Set deviceBattery
///
///
/// returns:
/// <a href="x-source-tag://UserMetadataBuilder">UserMetadataBuilder</a>
- (UserMetadataBuilder * _Nonnull)setWithDeviceBattery:(NSString * _Nullable)deviceBattery SWIFT_WARN_UNUSED_RESULT;
...
/// Setter for deviceOrientation.
/// \param deviceOrientation Set deviceOrientation
///
///
/// returns:
/// <a href="x-source-tag://UserMetadataBuilder">UserMetadataBuilder</a>
- (UserMetadataBuilder * _Nonnull)setWithDeviceOrientation:(NSString * _Nullable)deviceOrientation SWIFT_WARN_UNUSED_RESULT;
